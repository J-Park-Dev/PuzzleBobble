...
void Light::setAmbient(const float* rgba) {
...
void Light::setDiffuse(const float* rgba) {
...
void Light::setSpecular(const float* rgba) {
...
void Light::draw() const {
	...
	float light_position[] = { pos[0], pos[1], pos[2], 0 };
